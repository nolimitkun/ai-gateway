...
ROWS = (
    ...
    ("Authorization: no tier / medium→big / big→big", "authorization"),
    ("Tier authorization: explicit big/medium/small tasks / auto tiers", "tier_authorization"),
    ("Tier ceiling: medium→big / big→big", "tier_ceiling"),
    ("Tenant metadata cannot bypass tier", "tier_independent_of_tenant"),
    ...
    ("Body-model routing without BBR", "native_routing"),
    ("Native path: forged model header", "native_spoof"),
    ("Native path: tier ceiling", "native_tier_ceiling"),
    ("Native path: catalog / auto / speech", "native_gaps"),
