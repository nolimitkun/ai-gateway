# KServe gateway comparison — 2026-08-24 15:52 UTC
...
| chat endpoint selection and success | 2 pods; 0 unknown; 30/30 HTTP 200 | 2 pods; 0 unknown; 30/30 HTTP 200 | 2 pods; 0 unknown; 30/30 HTTP 200 |
| streaming usage chunk | yes | yes | yes |
| embeddings API | yes | yes | yes |
| reranking API | yes | yes | yes |
| speech-to-text API | yes | yes | yes |
| p50 gateway-to-KServe latency | 299 ms | 230 ms | 307 ms |
