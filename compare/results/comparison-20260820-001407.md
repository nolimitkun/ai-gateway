# Gateway comparison — 2026-08-19 22:14 UTC
...
| weighted 80/20 split |   16 from alpha    4 from beta  |   14 from alpha    6 from beta  |
| p50 latency (0ms upstream) | 14 ms | 7 ms |
| control+data plane pods | 3 | 2 |
| data plane containers | `envoy shutdown-manager` | `agentgateway` |
