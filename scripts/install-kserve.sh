#!/usr/bin/env bash
# Install the standalone KServe LLMInferenceService controller in every
# comparison cluster. The gateway stacks already provide Gateway API + GAIE.
set -euo pipefail
...
echo "OK: KServe LLMInferenceService controller ready in all clusters"
